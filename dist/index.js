...
var m = {xml:!0, svg:!0, math:!0}, u = {checked:!0, compact:!0, declare:!0, defer:!0, disabled:!0, ismap:!0, multiple:!0, nohref:!0, noresize:!0, noshade:!0, nowrap:!0, readonly:!0, selected:!0}, w = {AREA:!0, BASE:!0, BASEFONT:!0, BR:!0, BGSOUND:!0, COL:!0, COMMAND:!0, FRAME:!0, HR:!0, IMG:!0, INPUT:!0, ISINDEX:!0, KEYGEN:!0, LINK:!0, META:!0, PARAM:!0, SOURCE:!0, TRACK:!0, EMBED:!0, WBR:!0, area:!0, base:!0, basefont:!0, br:!0, bgsound:!0, col:!0, command:!0, frame:!0, hr:!0, img:!0, input:!0, 
isindex:!0, keygen:!0, link:!0, meta:!0, param:!0, source:!0, track:!0, embed:!0, wbr:!0}, E = {SCRIPT:!0, STYLE:!0, TEXTAREA:!0, TITLE:!0, PLAINTEXT:!0, XMP:!0, script:!0, style:!0, textarea:!0, title:!0, plaintext:!0, xmp:!0}, H = {CAPTION:{ARTICLE:!0, SECTION:!0, NAV:!0, ASIDE:!0, H1:!0, H2:!0, H3:!0, H4:!0, H5:!0, H6:!0, HEADER:!0, FOOTER:!0, ADDRESS:!0, P:!0, HR:!0, PRE:!0, BLOCKQUOTE:!0, OL:!0, UL:!0, DL:!0, FIGURE:!0, DIV:!0, A:!0, EM:!0, STRONG:!0, SMALL:!0, S:!0, CITE:!0, Q:!0, DFN:!0, ABBR:!0, 
...
function M(a) {
  ...
  function W(n, q, v, f) {
    function p(J, K) {
      P[J] = !0 === K ? !0 : u[J.toLowerCase()] ? r ? z(K || J) : !0 : z(K || "");
      ++Q;
    }
    function g() {
      (F = "/>" === f.substr(k, 2)) && ++k;
    ...
    for (var b = 1, B = f.length, k = 2, P = {}, Q = 0, F = !1, h, A, x, C, R, G; k < B && 9 > b;) {
      h = f.charAt(k);
      switch(b) {
        case 1:
          if (L[h] & 4) {
        ...
        case 4:
          ...
          break;
        case 5:
          '"' === h || "'" === h ? (b = 6, R = h, x = k + 1) : L[h] & 4 || (b = 7, x = k);
          G = !1;
          break;
        case 6:
          G || h !== R || (b = 2, p(C, f.substring(x, k)));
          G = "\\" === h && !G;
          break;
        case 7:
    ...
    if (9 === b) {
      ...
      v.ja(r || t ? A : b, Q ? P : null, F, k);
      return k;
    }
    return 0;
  }
  for (var D = [], r = !!c.ea, t = !1, S = a.length - e, l, d; a;) {
    l = D[D.length - 1];
    if (E[l]) {
