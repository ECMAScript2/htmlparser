...
function aa(a) {
  ...
  function M(e, p, t, f) {
    ...
    if (0 <= m) {
      for (; m < g;) {
        p.$(e[--g], f && !P[e[g]], !1), v && l[e[g]] && (v = !!p.ea);
      }
      e.length = m;
      if (w) {
        for (w = !1, g = m; g;) {
  ...
  function ca(e, p, t, f) {
    function m(N, O) {
      ...
      T[N] = !0 === O ? !0 : q[N.toLowerCase()] ? v ? S(O || N) : !0 : S(O || "");
      ++U;
    }
    function g() {
      (G = "/>" === f.substr(k, 2)) && ++k;
    ...
    for (var b = 1, C = f.length, k = 2, T = {}, U = 0, G = !1, h, B, x, D, V, J; k < C && 9 > b;) {
      ...
      switch(b) {
        ...
        case 3:
          ...
          break;
        case 4:
          "=" === h ? b = 5 : ">" === h || g() ? (b = 9, m(D, !0)) : Q[h] & 4 || (b = 3, m(D, !0), x = k);
          break;
        case 5:
          '"' === h || "'" === h ? (b = 6, V = h, x = k + 1) : Q[h] & 4 || (b = 7, x = k);
          J = !1;
          break;
        case 6:
          ...
          break;
        case 7:
          Q[h] & 4 ? b = 2 : ">" === h && (b = 9), 7 !== b && m(D, f.substring(x, k));
      }
      ++k;
    }
    if (9 === b) {
  ...
  for (var r = R, v = !!R.ea, c = 0, w = !1, H = [], W = a.length - c, z, I, d, L; a;) {
    z = H[H.length - 1];
    I = E[z];
    if (a.indexOf("<?") === c) {
      if (n(), d = a.indexOf("?>"), -1 !== d) {
        r.ia(F(a.substring(2, d))), a = a.substring(d + 2);
      } else {
        A(a);
        return;
      }
      ...
      if (n(), d = a.indexOf("--\x3e"), -1 !== d) {
        r.ga(F(a.substring(4, d))), a = a.substring(d + 3);
      } else {
        A(a);
        return;
      }
