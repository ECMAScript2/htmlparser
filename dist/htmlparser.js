...
(function(F, K, ca) {
  ...
  function W(a, q, k) {
    ...
    function Y(f, r, t) {
      for (var d = 0, n = t.length, m = 3, b, A; m < n && 2 !== d;) {
        A = t.charAt(m);
        switch(d) {
          case 0:
            u[A] & 4 ? d = 1 : ">" === A && (d = 2);
      ...
      return 2 === d ? (Q[b] || L(f, r, k || H ? b : b.toUpperCase(), !1), m) : 0;
    }
    function L(f, r, t, d) {
      var n = 0, m = f.length;
      if (t) {
      ...
      if (0 <= n) {
        for (; n < m;) {
          r.aa(f[--m], d && !l[f[m]], !1), k && R[f[m]] && (k = !!r.ca);
        }
        f.length = n;
      } else {
        r.aa(t, !1, !0);
    ...
    function Z(f, r, t, d) {
      function n(M, N) {
        S[M] = !0 === N ? !0 : aa[M.toLowerCase()] ? k ? P(N || M) : !0 : P(N || "");
        ++T;
      }
      function m() {
        (D = "/>" === d.substr(h, 2)) && ++h;
      ...
      for (var b = 1, A = d.length, h = 2, S = {}, T = 0, D = !1, g, B, v, C, U, I; h < A && 9 > b;) {
        g = d.charAt(h);
        switch(b) {
          case 1:
            if (u[g] & 4) {
          ...
          case 3:
            if ("=" === g) {
              b = 5, C = d.substring(v, h);
            } else if (u[g] & 4) {
              b = 4, C = d.substring(v, h);
            } else if (">" === g || m()) {
              b = 9, n(d.substring(v, h), !0);
            }
            break;
          case 4:
          ...
          case 5:
            ...
            break;
          case 6:
            I || g !== U || (b = 2, n(C, d.substring(v, h)));
            I = "\\" === g && !I;
            break;
          case 7:
            u[g] & 4 ? b = 2 : ">" === g && (b = 9), 7 !== b && n(C, d.substring(v, h));
        }
        ++h;
      }
      if (9 === b) {
        ...
        if (!k && !H) {
          for (; r;) {
            if (l[r] && !l[r][b]) {
              L(f, t, r, !1), r = f[f.length - 1];
            } else {
              break;
            }
          }
        }
        (D = D || !!Q[b]) || (f[f.length] = k || H ? B : b);
        t.da(k || H ? B : b, T ? S : null, D, h);
        return h;
      }
      return 0;
    }
    for (var c = 0, H = !1, E = [], V = a.length - c, w, G, e, J; a;) {
      w = E[E.length - 1];
      G = ba[w];
      if (a.indexOf("<?") === c) {
        if (y(), e = a.indexOf("?>"), -1 !== e) {
          a = a.substr(e + 2);
        } else {
          z(a);
          return;
        ...
        if (G && ("PLAINTEXT" === w || "plaintext" === w ? J = !0 : a.indexOf(w.toLowerCase(), c) !== c + 2 && a.indexOf(w.toUpperCase(), c) !== c + 2 && (J = !0)), J) {
          x(), J = !1;
        } else if (y(), e = Y(E, q, a)) {
          a = a.substr(e);
        } else {
        ...
        if (y(), e = a.indexOf(">"), -1 !== e) {
          q.ha(a.substring(c, e + 1)), a = a.substr(e + 1);
        } else {
          z(a);
          return;
        }
  ...
  F.onload = function() {
    var a = F.input || K.all("input"), q = F.output || K.all("output");
    (F.form || K.all("form")).onsubmit = bz;
    function bz(k) {
      k && k.preventDefault();
