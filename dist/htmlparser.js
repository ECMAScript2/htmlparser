...
(function(S, H, Y) {
  function T(a) {
    ...
    for (var g = r, d = 0, E = [], v = !!g.da, B = !1, R = a.length - d, k, c; a;) {
      ...
      if (X[k]) {
        ...
        if (q(), c = a.indexOf("?>"), -1 !== c) {
          t(a.substring(2, c)), a = a.substring(c + 2);
        } else {
          g.aa(a);
          return;
        }
        ...
        if (q(), c = a.indexOf("]]\x3e"), -1 !== c) {
          t(a.substring(9, c)), a = a.substring(c + 3);
        } else {
          g.aa(a);
          return;
        }
        ...
        if (q(), c = a.indexOf("--\x3e"), -1 !== c) {
          t(a.substring(4, c)), a = a.substring(c + 3);
        } else {
          g.aa(a);
          return;
        }
  ...
  var M = {xml:!0, svg:!0, math:!0}, W = {checked:!0, compact:!0, declare:!0, defer:!0, disabled:!0, ismap:!0, multiple:!0, nohref:!0, noresize:!0, noshade:!0, nowrap:!0, readonly:!0, selected:!0, itemscope:!0, loop:!0, reversed:!0, async:!0, scoped:!0, draggable:!0, hidden:!0, novalidate:!0, autofocus:!0, required:!0, amp:!0}, L = {AREA:!0, BASE:!0, BASEFONT:!0, BR:!0, BGSOUND:!0, COL:!0, COMMAND:!0, FRAME:!0, HR:!0, IMG:!0, INPUT:!0, ISINDEX:!0, KEYGEN:!0, LINK:!0, META:!0, PARAM:!0, SOURCE:!0, 
  TRACK:!0, EMBED:!0, WBR:!0, area:!0, base:!0, basefont:!0, br:!0, bgsound:!0, col:!0, command:!0, frame:!0, hr:!0, img:!0, input:!0, isindex:!0, keygen:!0, link:!0, meta:!0, param:!0, source:!0, track:!0, embed:!0, wbr:!0}, X = {SCRIPT:!0, STYLE:!0, TEXTAREA:!0, TITLE:!0, PLAINTEXT:!0, XMP:!0, script:!0, style:!0, textarea:!0, title:!0, plaintext:!0, xmp:!0}, l = {CAPTION:{ARTICLE:!0, SECTION:!0, NAV:!0, ASIDE:!0, H1:!0, H2:!0, H3:!0, H4:!0, H5:!0, H6:!0, HEADER:!0, FOOTER:!0, ADDRESS:!0, P:!0, 
  ...
  HTML:{HEAD:!0, BODY:!0}, HEAD:{TITLE:!0, BASE:!0, BGSOUND:!0, LINK:!0, META:!0, STYLE:!0, SCRIPT:!0, NOSCRIPT:!0, TEMPLETE:!0}, COLGROUP:{COL:!0}, OPTGROUP:{OPTION:!0}, OPTION:{}, TBODY:{TR:!0}, TR:{TH:!0, TD:!0}, RBC:{RB:!0, RP:!0, RT:!0}}, x, r;
  l.LI = l.TD = l.DD;
  l.TH = l.DT;
  l.RB = l.RP = l.RT = l.P;
  ...
  r = {$:"", aa:function(a) {
    ...
    r.$ += "<" + a;
    for (z in q) {
      a = q[z], r.$ += " " + z + (!0 !== a ? '="' + a.split('"').join('\\"').split('\\\\"').join('\\"') + '"' : "");
    }
    r.$ += (t ? "/" : "") + ">";
  }, ca:function(a) {
    r.$ += "</" + a + ">";
